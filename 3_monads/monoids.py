# Verbatim copy of ../1_monoids/monoids.py, kept here so monads.py can import the
# Summary monoid without reaching into a sibling directory. Nothing below changed
